...
estado_pendiente = Estado("PendienteRevision", "EventoSismico")

estados = [estado_finalizado, estado_detectado, estado_finalizado, estado_bloqueado, estado_rechazado, estado_pendiente, estado_confirmado]
